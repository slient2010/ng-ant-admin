...
export class NHttpClinet {
  ...
  parseHeaders(): HttpHeaders {
    ...
    // todo: 登录时确定token值
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidXNlcm5hbWUiOiLmnajlkJsiLCJpYXQiOjE1MTYyMzkwMjJ9.T1Hvf_v_isIGLXKPNE_1UvFzO5CL9r0ybjr5C-pC4jM";
